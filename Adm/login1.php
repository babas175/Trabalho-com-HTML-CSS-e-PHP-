...
<body>
    <div class="container">
        <div class="content first-content">
            <div class="first-column">
                <h2 class="title title-primary">Administrador</h2>
                <br>
                <br>
                <a href="../Morador/login1.php" class="button1">Eu sou Morador clique aqui</a>
            ...
            <div class="second-column">
                ...
                <form class="form" action="login.php" method="POST" id="form_login_adm">
    ...
    <script name="script" type="text/javascript" src="../custom.js/validacao_login_adm.js"></script>
</body>
</html>